...
import GoalSetter from '../Dashboard/GoalSetter';
...
const MainReminder = () => {
  ...
  return (
    <div className="container mx-auto p-6 flex justify-center items-start min-h-screen font-oswald text-textgray bg-black ">
     <div className='bg-bg_black w-fit p-6 '>
     <ToastContainer />
