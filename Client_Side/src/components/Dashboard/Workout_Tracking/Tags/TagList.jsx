...
const TagList = () => {
  ...
  return (
    <div className="h-screen flex items-start justify-center text-textgray font-oswald bg-black p-4">
      <div className="max-w-4xl w-full mx-auto p-4 bg-bg_black rounded-lg shadow-md">
        <ToastContainer />
        ...
        <div className="mb-4 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0 md:mr-4 w-full md:w-auto">
            <input
              ...
              className="px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-orangecolor focus:border-transparent"
            />
          </div>
