...
function ProgressList() {
    ...
    const TableBody = () => (
        <tbody>
            {currentProgress.map(item => (
                <tr key={item._id} className="bg-bg_black  border border-black">
                    <td className="px-4 py-2 border border-black">{item.weight}</td>
                    <td className="px-4 py-2 border border-black">{item.chest}</td>
                    <td className="px-4 py-2 border border-black">{item.waist}</td>
                    <td className="px-4 py-2 border border-black">{item.hips}</td>
                    <td className="px-4 py-2 border border-black">{item.runTime}</td>
                    <td className="px-4 py-2 border border-black">{item.benchPress}</td>
                    <td className="px-4 py-2 border border-black">{item.squat}</td>
                    <td className="px-4 py-2 border border-black">{item.deadlift}</td>
                    <td className="px-4 py-2 border border-black">{formatDateTime(item.date)}</td>
    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-center bg-black">
                <div className="max-w-4xl w-full mx-auto mt-8 p-4 bg-bg_black font-oswald text-textgray rounded-lg shadow-md">
                    ...
                    <div className="mb-4 flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="bg-orangecolor text-white px-4 py-2 rounded flex items-center hover:bg-black transition-all duration-500 focus:outline-none"
                            >
                    ...
                    <div className="overflow-x-auto mt-4 rounded">
                        <table className="w-full table-auto text-sm md:text-base border-collapse">
                            <thead>
                                <tr className="bg-bg_black border border-black">
